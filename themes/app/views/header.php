...
<nav class="layout-navbar navbar navbar-expand-xl align-items-center bg-navbar-theme d-print-none" id="layout-navbar">
    <div class="container-xxl">
        <div class="navbar-brand app-brand demo d-none d-xl-flex py-0 me-4">
            <a href="<?= url("app") ?>" class="app-brand-link gap-2">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                    <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                        <div class="avatar avatar-online">
                            <img src="<?= \Source\Models\Auth::user()->photo() ?>" alt class="rounded-circle"/>
                        </div>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <a class="dropdown-item" href="#">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1">
                                        <span class="fw-medium d-block lh-1"><?= \Source\Models\Auth::user()->fullName() ?></span>
                                    </div>
                                </div>
                            </a>
                        </li>
                        ...
                        <li>
                            <a class="dropdown-item" href="<?= url("/app/sair") ?>">
