...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="<?= url("app/product") ?>">
                <input type="hidden" name="id" value="<?= $product->id ?>">
                <input type="hidden" name="update" value="true">
                <div class="mb-3">
                    <label class="form-label">Título</label>
                    <input type="text" class="form-control" name="title" value="<?= htmlspecialchars($product->title, ENT_QUOTES, 'UTF-8') ?>" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="price" class="form-control money" value="<?= $product->price ?>" required>
                </div>

                <div class="mb-3">
                    <img src="<?= $product->cover ?>" width="160px" class="rounded-circle">
                    <br>
                    <label class="form-label">Foto</label>
                    <small class="text-muted ms-3">
                        Não é possível fazer upload de imagens. Para exibir a foto forneça a URL.
                    </small>
                    <input type="text" name="cover" class="form-control" value="<?= $product->cover ?>" required>
                </div>
