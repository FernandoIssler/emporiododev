                ...
                <div class="row row--30">
                        ...
                        <div class="contact-form">
                            ...
                            <form id="contact-form" method="POST" action="#" class="axil-contact-form">
                                <div class="row row--10">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label for="contact-phone">Fone <span>*</span></label>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group mb--0">
                                            <button name="submit" type="submit" id="submit" class="axil-btn btn-bg-primary">
                                                Enviar
                                            </button>
                                        </div>
                                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="contact-location mb--40">
                            ...
                            <span class="address mb--20">Faculdade Adventista da Bahia</span>
                            <span class="phone">Phone: (75) 0000-0000</span>
                            <span class="email">Email: loja@emporiododev.com.br</span>
                        </div>
                        <div class="contact-career mb--40">
                            <p class="text-danger">Esse formulário não está funcional</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="axil-google-map-wrap axil-section-gap pb--0">
                <div class="mapouter">
                    <div class="gmap_canvas">
                        <iframe width="1080" height="500" id="gmap_canvas" src="https://maps.google.com/maps?q=cachoeira&amp;t=&amp;z=13&amp;ie=UTF8&amp;iwloc=&amp;output=embed"></iframe>
                    </div>
                </div>
            </div>
            <!-- End Google Map Area  -->
