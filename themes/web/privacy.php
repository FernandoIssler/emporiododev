                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-4">
                                ...
                                <p><span style="color: rgb(68, 68, 68);">A sua privacidade é importante para nós. É
                                        política do <?= CONF_SITE_NAME ?> respeitar a sua privacidade em relação a
                                        qualquer informação sua que possamos coletar no site
                                        <?= CONF_SITE_NAME ?>, e outros sites que possuímos e
                                        operamos.</span>
                                </p>
                                ...
                                <p><span style="color: rgb(68, 68, 68);">Apenas retemos as informações coletadas pelo
                                ...
                                <p><span style="color: rgb(68, 68, 68);">O nosso site pode ter links para sites externos
                                ...
                                <p><span style="color: rgb(68, 68, 68);">Você é livre para recusar a nossa solicitação
                                ...
                                <p><span style="color: rgb(68, 68, 68);">
                                        <ul>
                                            ...
                                            <li><span style="color: rgb(68, 68, 68);">Utilizamos anúncios para compensar
                                ...
                                <p><span style="color: rgb(68, 68, 68);">O usuário se compromete a fazer uso adequado
                                        dos conteúdos e da informação que o <?= CONF_SITE_NAME ?>> oferece no site e com
                                        caráter
                                ...
                                <ul>
                                    ...
                                    <li><span style="color: rgb(68, 68, 68);">C) Não causar danos aos sistemas físicos
                                            (hardwares) e lógicos (softwares) do <?= CONF_SITE_NAME ?>>, de seus
                                            fornecedores ou
                                ...
                                <p><span style="color: rgb(68, 68, 68);">Esperamos que esteja esclarecido e, como
                                        ...
                                        não, geralmente é mais habitual deixar os cookies ativados, caso interaja com um
