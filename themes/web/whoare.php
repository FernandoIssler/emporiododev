...
<main class="main-wrapper">
    ...
    <div class="axil-product-area bg-color-white axil-section-gap">
        <div class="container">
            ...
            <h2>Nossa Missão</h2>
            <p>Nossa missão é oferecer produtos de alta qualidade que atendam às necessidades e desejos dos nossos
                clientes, sempre com um atendimento personalizado e eficiente. Trabalhamos com os melhores fornecedores
                e marcas para garantir que você tenha acesso ao que há de melhor no mercado.</p>

            <h2>Nossos Valores</h2>
            <div class="highlight">
                <p><strong>Qualidade:</strong> Buscamos sempre a excelência em nossos produtos e serviços.</p>
                <p><strong>Inovação:</strong> Estamos constantemente atualizando nosso catálogo com as últimas novidades
                    e tendências.</p>
                <p><strong>Satisfação do Cliente:</strong> Sua satisfação é nossa prioridade. Estamos aqui para ouvir
                    você e melhorar continuamente.</p>
                <p><strong>Ética:</strong> Atuamos com transparência e responsabilidade em todas as nossas ações.</p>
            </div>

            <h2>Nosso Compromisso</h2>
            <p>Estamos comprometidos em oferecer uma experiência de compra segura, fácil e agradável. Nossa equipe de
                atendimento ao cliente está sempre pronta para ajudar, seja para esclarecer dúvidas, resolver problemas
                ou fornecer informações adicionais.</p>

            <h2>Junte-se a Nós</h2>
            <p>Queremos que você faça parte da nossa história! Acompanhe nossas redes sociais, assine nossa newsletter e
