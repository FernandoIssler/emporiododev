...
use Source\Models\App\Athletic;
...
class User extends Model
{
    ...
    {
        return (new userAddress())->find("user_id = :user", "user={$this->id}")->fetch();
    }

    /**
     * @return array|mixed|Model|null
     */
    public function athletic(): mixed
    {
        if ($this->athletic) {
            $athletic = (new Athletic())->find("id = :id", "id={$this->athletic}")->fetch();
        }
